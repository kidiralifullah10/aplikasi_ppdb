...
$perintah="SELECT * FROM ro_formulir";
?>
...
<div class="panel-heading">
<h4 class="panel-title">
<a data-toggle="collapse" data-parent="#accordion" href="#collapseEnam">DATA PEMILIHAN JURUSAN #6</a>
</h4>
</div>
...
<div class="panel-body">
    <div class="form-group">
      ...
      <select class="form-control" name="jurusan_1" id="jurusan_1" maxlength="4" minlength ="4" required="">
        <option value="">Pilih</option>
...
<div class="panel-body">
    <div class="form-group">
      ...
      <select class="form-control" name="jurusan_2" id="jurusan_2" maxlength="4" minlength ="4" required="">
         <option value="">Pilih</option>
        <option value="teknik sepeda motor">teknik sepeda motor</option>
        <option value="busana butik">busana butik</option>
        <option value="akutansi">akutansi</option>
...
<button type="reset" class="btn btn-default">Batal
</button>
