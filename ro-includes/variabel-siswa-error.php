...
<!-- Error Jurusan -->
<div class="<?php echo $jurusan_1Class; ?>" role="alert">
  <span class="<?php echo $jurusan_1Class_icon;?>" aria-hidden="true"></span>
  <span class="sr-only">Error:</span>
  <?php echo"$jurusan_1Err";?>
</div>
<div class="<?php echo $jurusan_2Class; ?>" role="alert">
  <span class="<?php echo $jurusan_2Class_icon;?>" aria-hidden="true"></span>
  <span class="sr-only">Error:</span>
  <?php echo"$jurusan_2Err";?>
</div>
<!-- Error End -->
